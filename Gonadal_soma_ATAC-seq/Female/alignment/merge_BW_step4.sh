...
outdir=/u/scratch/j/jadiruss/soma/female_soma/bw
...
bamCoverage -b $reads/$fq"_ATAC_sorted.bam" -o $outdir/$fq"_RPKM_bs10.bw" -bs 10 -p $threads \
--normalizeUsing RPKM

bamCoverage -b $reads/$fq"_ATAC_sorted.bam" -o $outdir/$fq"_RPGC_bs10.bw" -bs 10 -p $threads \
