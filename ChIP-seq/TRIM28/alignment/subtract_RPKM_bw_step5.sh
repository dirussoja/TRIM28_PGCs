...
-o $out/$fq"_RPKM_subtract_bs10.bw" --scaleFactorsMethod None --normalizeUsing RPKM --operation subtract -bs 10 -e --smoothLength 20 -p $threads 

bamCompare -b1 $reads/$fq"_merge_sorted.bam" -b2 $reads/$fq"_Inp_merge_sorted.bam" \
-o $out/$fq"_RPKM_log2_bs10.bw" --scaleFactorsMethod None --normalizeUsing RPKM --operation log2 --pseudocount 1 -bs 10 -e --smoothLength 20 -p $threads 
